...
// update self-updates the perplexity-cli binary by cloning the latest source from GitHub,
...
const repoURL = "https://github.com/the20100/perplexity-cli"

var updateCmd = &cobra.Command{
	Use:   "update",
	Short: "Update perplexity-cli to the latest version from GitHub",
...
func runUpdate(cmd *cobra.Command, args []string) error {
	...
	tmpDir, err := os.MkdirTemp("", "perplexity-cli-update-*")
	if err != nil {
	...
	newBin := filepath.Join(tmpDir, "perplexity-cli")
